...
function StatusPill({ status }: { status: ReturnType<typeof usePython>['status'] }) {
  const map = {
    booting: { text: 'Python 준비 중…', className: 'bg-cheese-100 text-cheese-600' },

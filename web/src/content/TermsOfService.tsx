    ...
    <>
      ...
      <PolicyArticle num="제2조" title="정의">
        <ol>
          ...
          <li>
            <strong>콘텐츠</strong> — 교사가 서비스에 업로드하는 수업자료·동아리(Lab)
            활동자료 파일(이미지·동영상 등 첨부 포함), 교사가 등록하는 외부 링크(유튜브
            영상 링크 등), 이용자가 작성하는 실습 코드
          </li>
        </ol>
      </PolicyArticle>
      ...
      <PolicyArticle num="제6조" title="교사의 의무">
        <p>교사는 수업자료·동아리(Lab) 활동자료를 업로드하거나 외부 링크를 등록할 때 다음 사항을 준수해야 합니다.</p>
        <ol>
          <li>
      ...
      <PolicyArticle num="제8조" title="지식재산권">
        <ol>
          ...
          <li>
            교사가 업로드한 수업자료·동아리(Lab) 활동자료의 지식재산권은 해당 교사(또는
            원저작권자)에게 있으며, 서비스 운영자는 자료를 서비스 제공 목적 범위 내에서만
            저장·전송합니다.
          </li>

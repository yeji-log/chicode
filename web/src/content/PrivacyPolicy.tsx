    ...
    <>
      ...
      <PolicyArticle num="제8조" title="아동의 개인정보 보호">
        <p>
          ...
          경우는 없습니다. 다만 담당 교사가 수업 운영 목적으로 학생의 학번·이름과
          날짜별 수업 참여 여부를 직접 입력해 관리하는 "수업기록" 기능이 있으며, 이
          역시 고등학생을 대상으로 합니다. 이 정보는 로그인한 교사만 열람·수정할 수
          있고 학생은 접근할 수 없으며, 담당 교사가 직접 삭제하기 전까지 보관됩니다(제3조
          참고).
        </p>
        <p>
          「개인정보 보호법」 제22조의2 등 관련 법령에 따라, 향후 만 14세 미만 아동을
          대상으로 하는 기능을 추가하는 경우 법정대리인의 동의를 받는 절차를 먼저
          마련한 뒤 이 방침에 반영합니다. 만 14세 미만 아동의 개인정보가 수집된 사실이
          확인될 경우 지체 없이 삭제 등 필요한 조치를 취합니다.
        </p>
      </PolicyArticle>

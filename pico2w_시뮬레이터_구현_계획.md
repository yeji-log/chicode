...
> **이 절의 부품 목록은 낡았다.** 여기 적힌 5종(LED/RGB/부저/버튼/스위치)은
> 2026-08-25 에 14종으로 늘었고, 아래에서 "일부러 안 넣었다"고 한 ADC/PWM 부품
> (가변저항·조도센서·서보)도 전부 들어갔다. 그 설계는 `pico_센서_확장_구현_계획.md`
> 에 있다. 이 절은 "왜 그때는 안 넣었는가"의 기록으로만 읽을 것.
